...
si veda il documento \normediprogettov.
		\subsection{Misure e metriche}\label{MisureMetriche}
			...
			Vengono di seguito riportati i range stabiliti per la metrica appena introdotta:
			\begin{itemize}
				\item un valore maggiore di 60 è ritenuto negativo;
				\item un valore compreso tra 30 e 60 è ritenuto accettabile;
			...
			\begin{itemize}
				\item un valore maggiore di 10 è ritenuto negativo;
				\item un valore compreso tra 3 e 10 è ritenuto accettabile;
			...
			Vengono di seguito riportati i range stabiliti per la metrica appena introdotta:
			\begin{itemize}
				\item un valore maggiore di 100 è ritenuto negativo;
				\item un valore compreso tra 50 e 100 è ritenuto accettabile;
				\item un valore compreso minore di 50 è ritenuto ottimale.
			\end{itemize}
