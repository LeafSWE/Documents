...
\label{sec:Problemi personali tra i membri del team}
	...
	\paragraph*{Riscontro effettivo:}
		\begin{description}
			...
			\item[Fase PDROP - Progettazione di Dettaglio e codifica dei]  \ \\
					\textbf{Requisiti Opzionali} la scelta di iniziare il tirocinio di alcuni membri del team ha comportato sforzo aggiuntivo per gli altri membri. Nonostante qualche attrito iniziale, i membri del team hanno continuato a collaborare e a impegnarsi.
