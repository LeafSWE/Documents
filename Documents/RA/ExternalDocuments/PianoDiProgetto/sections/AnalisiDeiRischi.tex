...
\label{sec:Valutazione delle risorse}
	...
	\paragraph*{Riscontro effettivo:} 
		\begin{description}
			...
			\item[Fase PDROP - Progettazione di Dettaglio e codifica dei]  \ \\
					\textbf{Requisiti Opzionali} nonostante alcuni membri del team fossero meno disponibili per impegni esterni il resto del team è riuscito comunque ad eseguire le attività pianificate.
			%\item[Fase V - Validazione] ???
		\end{description}
...
\label{sec:Mancata comprensione}
	...
	\paragraph*{Riscontro effettivo:}
		\begin{description}
			...
			\item[Fase PDROP - Progettazione di Dettaglio e codifica dei]  \ \\
					\textbf{Requisiti Opzionali} l'analisi dei requisiti è solida e gli ultimi confronti con il proponente sono stati positivi.
			%\item[Fase V - Validazione] ???
		\end{description}
