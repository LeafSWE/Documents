...
\section{Panoramica generale}
	...
	%\paragraph*{•}
	% \begin{framed}
	% Nota: ogni volta che troverai una \g\ come pedice di una parola potrai confrontarti con il glossario presente nel manuale per comprendere meglio alcuni termini.
	% \end{framed}
