...
\begin{description}
	...
	\begin{itemize}
		...
		Metodo che viene invocato dalla classe in cui l'oggetto si è registrato come listener nel caso in cui la versione della mappa locale differisca dalla versione della mappa in remoto. Deve ritornare "true" nel caso in cui si voglia scaricare la mappa da remoto, "false" altrimenti
		...
		Metodo che viene invocato dalla classe in cui l'oggetto si è registrato come listener nel caso in cui non sia stata trovata una mappa nel database locale. Deve ritornare "true" nel caso in cui si voglia cercare la mappa nel database remote, "false" altrimenti
...
\paragraph{presenter::Checker}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/Checker.png}
...
\paragraph{presenter::DatabaseServiceManager}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/DatabaseServiceManager.png}
...
\paragraph{presenter::ImagePageAdapter}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/ImagePageAdapter.png}
	...
	\begin{itemize}
		...
		\begin{description}
			...
			\begin{itemize}
				...
				Interfaccia che serve per l'interazione con un Fragment\item \texttt{size : int}\\
				Numero di immagini passate\end{itemize}
		\end{description}
		\item \texttt{+ getCount() : int}\\
...
\paragraph{presenter::InformationManagerPresenter}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/InformationManagerPresenter.png}
...
\paragraph{presenter::NavigationManagerPresenter}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/NavigationManagerPresenter.png}
...
\paragraph{presenter::SettingManager}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/SettingManager.png}
...
\paragraph{view::ImageListFragmentView}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/ImageListFragmentView.png}
...
\paragraph{view::ImageListFragmentViewImp}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/ImageListFragmentViewImp.png}
...
\begin{description}
	...
	\begin{itemize}
		...
		Metodo utilizzato per confermare la rimozione di un log attraverso un dialog.
	\end{itemize}
\end{description}
...
\paragraph{view::MainView}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/MainView.png}
...
\paragraph{view::MainViewImp}
\
\begin{figure}[H]
	\centering
	\includegraphics[width=\maxwidth]{img/MainViewImp.png}
...
\begin{description}
	...
	\item[Metodi:] \
	\begin{itemize}
		\item \texttt{+ \textit{setAdapter(toDisplay : String[]) : void}}\\
		Metodo utilizzato per visualizzare tutti i POI nelle circostanze dell'utente
		\begin{description}
			\item[Argomenti:] \
			\begin{itemize}
				\item \texttt{toDisplay : String[]}\\
	...
	\begin{itemize}
		...
		\begin{description}
			...
			\begin{itemize}
				...
				Presenter della View che viene creata\end{itemize}
		\end{description}
		\item \texttt{+ setAdapter(toDisplay : String[]) : void}\\
...
\begin{description}
	...
	\item[Metodi:] \
	\begin{itemize}
		\item \texttt{+ \textit{setPoiListAdapter(toDisplay : String[]) : void}}\\
	...
	\begin{itemize}
		...
		\begin{description}
			...
			\begin{itemize}
				...
				Presenter della View che viene creata\end{itemize}
		\end{description}
		\item \texttt{+ setPoiListAdapter(toDisplay : String[]) : void}\\
