...
\begin{description}
	...
	\item[Metodi:] \
	\begin{itemize}
		\item \texttt{+ \underline{newInstance(photoUris : ArrayList<String>) : ImageDetailFragment}}\\
		...
		\begin{description}
			...
			\begin{itemize}
				...
				URI delle immagini associate all'istruzione scelta\end{itemize}
		\end{description}
	\end{itemize}
\end{description}
...
\begin{description}
	...
	\item[Metodi:] \
	\begin{itemize}
		\item \texttt{\# handleIntent(intent : Intent)}\\
		\textbf{Override} !
		\begin{description}
			\item[Argomenti:] \
			\begin{itemize}
